{ config, pkgs, ... }:
{
  ...
  programs.kitty = {
    ...
    settings = {
      ...
      color1 = ''#${config.stylix.base16Scheme.base04}''; # RED
      color2 = ''#${config.stylix.base16Scheme.base05}''; # GREEN
      color3 = ''#${config.stylix.base16Scheme.base06}''; # HIGHLIGH
      color4 = ''#${config.stylix.base16Scheme.base07}''; # BLUE
      color5 = ''#${config.stylix.base16Scheme.base08}''; # MAGENTA
      color6 = ''#${config.stylix.base16Scheme.base09}''; # CYAN
      color7 = ''#${config.stylix.base16Scheme.base0A}''; # WHITE
