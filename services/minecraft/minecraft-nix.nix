          ...
          "mods" = pkgs.linkFarmFromDrvs "mods" (
            builtins.attrValues {
              ...
              clothConfigAPI = pkgs.fetchurl {
                ...
                sha256 = "sha256-ikDITl7N5SWs+2xOE7gALaz8o++VNNf69ugEllb0I8g=";
              };
              ...
              noEndermanGrief = pkgs.fetchurl {
                url = "https://cdn.modrinth.com/data/ss02V75k/versions/JsguYUrA/no-enderman-grief-v3.0.1.jar";
                sha256 = "sha256-w5uz+6KMVO27pXxdW+Pu4tX4OtZLsgB08skETMn7Fj4=";
              };
            }
          );
