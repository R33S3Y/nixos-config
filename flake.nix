  ...
  outputs =
    ...
    let
      ...
      themes = {
        ...
        technicallyCorrectLight = import ./data/themes/technicallyCorrectLight/theme-flake.nix {
          inherit inputs;
        };
        technicallyCorrectDark = import ./data/themes/technicallyCorrectDark/theme-flake.nix {
          inherit inputs;
        };
      };
    in
