      ...
      cmsSurvival = {
        ...
        symlinks = { 
          ...
          "mods" = pkgs.linkFarmFromDrvs "mods" (builtins.attrValues {
            ...
            carpetExtra = pkgs.fetchurl { url = "https://cdn.modrinth.com/data/VX3TgwQh/versions/eAJGDnBx/carpet-extra-1.21.6-1.4.176.jar"; sha256 = "sha256-G01m8DMr2l3u4IdV5JPC1qxk1k1SheETSqA2BJdcJSE="; };
