      ...
      cmsSurvival = {
        ...
        symlinks = { 
          ...
          "mods" = pkgs.linkFarmFromDrvs "mods" (builtins.attrValues {
            ...
            litematica = pkgs.fetchurl { url = "https://cdn.modrinth.com/data/bEpr0Arc/versions/HkGaKquV/litematica-fabric-1.21.11-0.25.3.jar"; sha256 = "sha256-uR3siBSeBSSOIEsCyiY6atpv/AdaoLZ2o8smx5wHO8g="; };
          });
