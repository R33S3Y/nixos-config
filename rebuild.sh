...
if ! kitten ssh "${OBS_USER}@${OBSIDIAN_HOST}" "sudo rm -rf $CONFIG_DST/ && sudo mkdir $CONFIG_DST/ && sudo -S mv /tmp/config_tmp/* $CONFIG_DST/ && sudo -S nixos-rebuild switch --flake $CONFIG_DST/#obsidian"; then
