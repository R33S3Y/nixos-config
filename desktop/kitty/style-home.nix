...

{
  ...
  programs.kitty = {
    ...
    settings = {
      ...
      color5 = "#${config.stylix.base16Scheme.base0E}"; # MAGENTA
      color6 = "#${config.stylix.base16Scheme.base02}"; # CYAN
      color7 = "#${config.stylix.base16Scheme.base06}"; # WHITE
      ...
      color14 = "#${config.stylix.base16Scheme.base03}"; # BR CYAN
      color15 = "#${config.stylix.base16Scheme.base07}"; # BR WHITE
